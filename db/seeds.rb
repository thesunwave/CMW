...
quote = Quote.create([ 
	...
	{
		text_rus: "Ирония должна присутствовать и в дизайне, и в предметах. Я замечаю в окружающих меня людях профессиональную болезнь: всё воспринимается слишком серьезно. Один из моих секретов в том, что я постоянно шучу.", text_eng: "",
		author_rus: "Акилле Кастильони", author_eng: ""
	},
	{
	...
	{
		text_rus: "Невозможно создать хороший продукт, основываясь на опросах людей или пользуясь фокус-группами. Люди сами не знают чего они хотят, пока им это не покажешь.", text_eng: "",
		author_rus: "Стив Джобс", author_eng: ""
	}
